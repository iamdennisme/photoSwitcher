...
import com.dennisce.com.photoswitcher.adapter.FolderAdapter;
import com.dennisce.com.photoswitcher.adapter.ImageGridAdapter;
...
import com.dennisce.com.photoswitcher.utils.FileUtils;
import com.dennisce.com.photoswitcher.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mImageAdapter = new ImageGridAdapter(Objects.requireNonNull(getActivity()), showCamera(), 3);
        ...
        mCategoryText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mFolderPopupWindow.isShowing()) {
                    ...
                    Objects.requireNonNull(mFolderPopupWindow.getListView()).setSelection(index);
                }
            }
        });
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (mImageAdapter.isShowCamera()) {
                    if (i == 0) {
                        if (!CameraPermissionUtil.Companion.canUse(getActivity())) {
        ...
        mFolderAdapter = new FolderAdapter(Objects.requireNonNull(getActivity()));
    }
    ...
    private void createPopupFolderList() {
        Point point = ScreenUtils.INSTANCE.getScreenSize(Objects.requireNonNull(getActivity()));
        int width = point.x;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // load image data
        Objects.requireNonNull(getActivity()).getSupportLoaderManager().initLoader(LOADER_ALL, null, mLoaderCallback);
    }
    ...
    private void showCameraAction() {
        if (ContextCompat.checkSelfPermission(Objects.requireNonNull(getContext()), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(Objects.requireNonNull(getActivity()).getPackageManager()) != null) {
                try {
                    mTmpFile = FileUtils.INSTANCE.createTmpFile(getActivity());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        imageUri = FileProvider.getUriForFile(this.getContext(), "com.dennisce.fileprovider", mTmpFile);
                    } else {
    ...
    private LoaderManager.LoaderCallbacks<Cursor> mLoaderCallback = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            if (id == LOADER_ALL) {
                cursorLoader = new CursorLoader(Objects.requireNonNull(getActivity()),
